 ...
 */
@Keep
public class TopRoundedCornersTransform implements com.squareup.picasso.Transformation {
    private final float radius;  // dp
     ...
     */
    public TopRoundedCornersTransform(final float radius, final int margin) {
        this.radius = radius;
        this.margin = margin;
     ...
     */
    public TopRoundedCornersTransform(final int radius, final int margin, boolean topCornersOnly,
